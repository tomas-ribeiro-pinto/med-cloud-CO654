        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden">
                <div x-data='{ show: false }' class="sm:px-6 lg:px-8 mb-8">
                    <button @click="show = true" type="button" class="btn block float-right rounded-md bg-black px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-gray-800 dark:bg-gray-200 dark:text-black dark:hover:bg-gray-300">Adicionar Registo</button>
                    <x-add-hospital/>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-white">
                                    <a class="py-2 hover:underline cursor-pointer hover:font-bold">Hospital Name</a>
                                </th>
                            ...
                            @forelse($hospitals as $hospital)
                                <tr>
                                    <td class="whitespace-wrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 dark:text-white">{{$hospital->name}}</td>
                                    <td class="whitespace-wrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 dark:text-white">{{$hospital->address_line1}}, {{$hospital->address_line2}}</td>
                                    <td class="w-36">
                                        <div class="flex">
